...
public class Day10_2 {
    ...
    public String part2(List<String> input)  {
        ...
        return String.valueOf(output1.getFirst() * output2.getFirst() * output3.getFirst());
    }
    ...
    private void moveChip(Map<String, Bot> bots, String to, int value, List<Integer> output1, List<Integer> output2, List<Integer> output3) {
        switch (to.split(" ")[0]) {
