...
public class Day4_2 {
    ...
    public String part2(List<String> input) {
        ...
        return String.valueOf(Integer.parseInt(guards.getFirst().id) * guards.getFirst().strategyInformation.mostSleptMinute);
    }
    ...
    private List<Guard> getGuards(List<Record> records) {
    ...
    private void calculateMostSleptMinutes(Collection<Guard> guards) {
    ...
    private Guard getSleepiest(Collection<Guard> guards) {
