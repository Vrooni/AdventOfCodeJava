...
public class Day16_1 {
    ...
    public String part1(List<String> lines) {
        ...
        return String.valueOf(searchBestWay(0, "AA", null, valves, map));
    }

    private int searchBestWay(int minutes, String position, String target, Map<String, Valve> valves, Map<String, Map<String, String>> map) {
        if (minutes == 30) {
            return 0;
        }
    ...
    private Map<String, Map<String, String>> getMap(Map<String, Valve> valves) {
