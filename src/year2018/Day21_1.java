...
public class Day21_1 {
    ...
    public String part1(List<String> input) {
        ...
        return String.valueOf(getPossibleValue(instructions, registers, pointer));
    }
     ...
     */
    private int getPossibleValue(List<Instruction> instructions, int[] registers, int pointer) {
