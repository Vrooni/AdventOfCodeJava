...
public class Day8_1 {
    ...
    public String part1(List<String> input) {
        ...
        for (int i = 0; i < 1000; i++) {
            ...
            List<Set<JunctionBox>> matchingCircuits = circuits.stream().filter(circuit ->
                            circuit.contains(distance.box1) || circuit.contains(distance.box2)).toList();
            ...
            // union circuits
                ...
                Set<JunctionBox> newCircuit = new HashSet<>(matchingCircuits.stream()
        ...
        return String.valueOf(circuits.get(0).size() * circuits.get(1).size() * circuits.get(2).size());
    }
}
