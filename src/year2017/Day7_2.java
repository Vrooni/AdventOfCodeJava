...
public class Day7_2 {
    ...
    public String part2(List<String> input) {
        ...
        return String.valueOf(getOffBalanced(programNames.getFirst(), programs).weight);
    }
     ...
     */
    private Result getOffBalanced(String program, Map<String, ProgramInformation> programs) {
        ...
        return new Result(offWeight.isEmpty(), offWeight.isPresent()
                        ...
                        : information.weight + sum(weights)
        );
    }
