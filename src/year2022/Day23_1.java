...
public class Day23_1 {
    ...
    public String part1(List<String> lines) {
        ...
        int minX = elves.stream().mapToInt(elv -> elv.x).min().getAsInt();
        int minY = elves.stream().mapToInt(elv -> elv.y).min().getAsInt();
        int maxX = elves.stream().mapToInt(elv -> elv.x).max().getAsInt();
        int maxY = elves.stream().mapToInt(elv -> elv.y).max().getAsInt();
