...
public class Day20_2 {
    ...
    public String part2(List<String> input) {
        ...
        return String.valueOf(getCheats(map, minDistance, distances));
    }

    private Position getEndPosition(char[][] map) {
    ...
    private int getMinDistance(char[][] map, Position end, Map<Node, Integer> distances) {
    ...
    private List<Node> getNeighbours(char[][] map, Node current) {
        int x = current.x;
        int y = current.y;
    ...
    private int getCheats(char[][] map, int minDistance, Map<Node, Integer> distances) {
        int cheats = 0;
        ...
        for (Node node : distances.keySet()) {
            ...
            for (int picoSecond = 1; picoSecond <= 20; picoSecond++) {
    ...
    private List<Position> getCheatNeighbours(char[][] map, Position current, int picoSecond) {
