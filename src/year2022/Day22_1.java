...
public class Day22_1 {
    ...
    private List<List<Element>> createMap(List<String> lines) {
    ...
    private MyPosition moveThrowMap(List<List<Element>> map, String moves) {
    ...
    private int getStartX(List<List<Element>> map) {
    ...
    private MyPosition doSteps(List<List<Element>> map, MyPosition myPosition, int steps) {
    ...
    private Element getElementOrNone(List<List<Element>> map, int x, int y) {
        if (y < 0 || y >= map.size()) {
            return Element.NONE;
        }
