...
public class Day5_2 {
    public String part2(List<String> input) {
        ...
        List<List<String>> correctedUpdates = getCorrectedUpdates(wrongUpdates, rules);
        int result = correctedUpdates.stream()
    ...
    private List<List<String>> getCorrectedUpdates(List<List<String>> wrongUpdates, Map<String, List<String>> rules) {
