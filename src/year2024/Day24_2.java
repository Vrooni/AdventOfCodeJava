...
public class Day24_2 {
    ...
    public String part2(List<String> input) {
        ...
        return String.join(",", falseOutputs);
    }
     ...
     */
    private Set<String> getFalseOutputs(List<Gate> gates) {
    ...
    private void addIf(boolean condition, Gate gate, Set<String> falseOutputs) {
        if (condition) {
